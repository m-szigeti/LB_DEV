        ...
        <div class="welcome-content">
            ...
            <div style="position:relative; margin-bottom:14px;">
                ...
                <div style="position:relative; border:1px solid #d8d8d8; border-radius:8px; background:#f7f7f7; padding:10px 12px 10px 46px;">
                    ...
                    <div style="font-size:12px; color:#555; margin-top:4px;">Under <strong>Stressors</strong>, enable population, shelter, road-access, or hotspot layers for additional context. Under <strong>UNDP Intervention Mapping</strong>, explore project locations clustered by activity type. These are <em>not</em> part of the composite index.</div>
                </div>
            </div>
            ...
            <div style="font-size:12px; color:#444; line-height:1.5; margin-bottom:10px;">
                ...
                <div style="margin-bottom:5px;"><span style="display:inline-block; width:10px; height:10px; border-radius:2px; background:#8e44ad; margin-right:6px;"></span><strong>Climate Risk</strong> &mdash; Environmental hazards, pollution, and climate-related pressures.</div>
                <div style="margin-bottom:5px;"><span style="display:inline-block; width:10px; height:10px; border-radius:2px; background:#e84393; margin-right:6px;"></span><strong>Political Vulnerability</strong> &mdash; Governance gaps, institutional fragility, political marginalization, and demographic shock pressures.</div>
